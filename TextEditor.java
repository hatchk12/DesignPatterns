...
class TextEditor {
    ...
    private void insert() {
        ...
        if (insertionIndex != -1) {
            ...
            undoRedoManager.execute(new InsertCommand(_document, insertionIndex, sequenceInput));
        }
    }
    ...
    private void delete() {
        ...
        if (deletionIndex != -1) {
            ...
            if (deletionDistance != -1) {
                undoRedoManager.execute(new DeleteCommand(_document,deletionIndex,deletionDistance));
            }
        }
    }
    ...
    private void replace() {
        ...
        if (replaceIndex != -1) {
            ...
            if (replaceDistance != -1) {
                ...
                undoRedoManager.execute(new ReplaceCommand(_document,replaceIndex,replaceDistance,replacementString));
            }
        }
    }
    ...
    private void open() {
        ...
        undoRedoManager.execute(new OpenCommand(_document,openFileName));
